...
def make_html(topic):
    ...
    for k,v in topic.items():
        if v: cards += '<div class="'+("h" if k=="知识点" else "b")+'">'+escape(k)+": "+escape(v)+'</div>'
    html = '''<!DOCTYPE html><html><head><meta charset=UTF-8><meta name=viewport content="width=device-width,initial-scale=1.0">
<style>body{margin:0;padding:0;background:#E8F5E9;font-family:sans-serif}.wrap{max-width:640px;margin:0 auto;background:#fff}.hd{background:linear-gradient(135deg,#1B5E20,#2E7D32);padding:30px 20px;text-align:center;color:#fff}.hd .t{font-size:20px;font-weight:bold}.hd .d{font-size:12px;color:#A5D6A7}.ct{padding:20px}.h{font-size:17px;font-weight:bold;color:#1B5E20;margin:24px 0 10px 0;border-bottom:2px solid #C8E6C9}.b{background:#E8F5E9;border-left:4px solid #4CAF50;padding:12px;margin:10px 0;font-size:14px;color:#1B5E20;line-height:1.7;border-radius:0 6px 6px 0}.ft{border-top:1px solid #E0E0E0;padding:16px;text-align:center;font-size:12px;color:#999}
</style></head><body><div class=wrap>
<div class=hd><p class=t>💰 每日财经干货</p><p class=d>'''+ds+'''</p></div>
<div class=ct>'''+cards+'''</div>
<div class=ft>本内容仅供参考。</div>
</div></body></html>'''
    return subj, html
